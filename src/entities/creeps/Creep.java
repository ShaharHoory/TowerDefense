...
public abstract class Creep extends Entity implements Visited, Tickable {
	public int speed;
	protected double HP;
	...
	private void moveWithinSlot(boolean direR, boolean direL, boolean direU, boolean direD) {
	...
	private void moveToNextSlot(Pair movement) {
		location.setLocation(location.x + movement.xInc, location.y + movement.yInc);
