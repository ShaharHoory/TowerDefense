...
public class Constants {
	...
	// -----------------Towers----------------------//
	// lava tower:
	public static final int lavaAttackSpeed = 1;
	public static final int lavaThreatRadius = 1;

	// arrow tower:
	public static final int arrowAttackSpeed = 2;
	public static final int arrowThreatRadius = 2;

	// poison tower:
	public static final int poisonAttackSpeed = 1;
	public static final int poisonThreatRadius = 1;

	// magic tower:
	public static final int magicAttackSpeed = 1;
	public static final int magicThreatRadius = 1;

	// sam tower:
	public static final int samAttackSpeed = 2;
	public static final int samThreatRadius = 2;

	// goku tower:
	public static final int gokuAttackSpeed = 1;
	public static final int gokuThreatRadius = 2;

	// dino tower:

	public static final int dinoAttackSpeed = 1;
	public static final int dinoThreatRadius = 2;
	...
	// skull:
	public static final int skullSpeed = 1;

	// mikeW:
	public static final int mikeWSpeed = 1;

	// Knight:
	public static final int knightSpeed = 1;
